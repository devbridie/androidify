...
import com.android.developers.androidify.creation.R
...
fun PhotoPrompt(
    ...
    externalAppCallback: DragAndDropTarget,
...
private fun TakePhotoButton(onCameraPressed: () -> Unit) {
    ...
    with(sharedElementScope) {
        Box(
            ...
            Image(
                painterResource(com.android.developers.androidify.theme.R.drawable.photo_camera),
